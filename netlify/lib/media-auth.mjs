...
.heart{font-size:30px;color:#813d6e}.couple{font-size:13px;letter-spacing:.06em;color:#7d7648;margin:18px 0}h1{font-size:36px;font-weight:400;line-height:1.15;margin:14px 0}p{font-size:16px;line-height:1.65;color:#615950}form{text-align:left;margin-top:28px}label{display:block;font-size:15px;margin-bottom:9px}input,button{width:100%;border-radius:4px;font:inherit;font-size:16px;min-height:48px}input{padding:12px;border:1px solid #7d764866;background:white;color:#2b2b2b}button{margin-top:14px;padding:12px;border:1px solid #813d6e;background:#813d6e;color:white;cursor:pointer}button:hover{background:#6c315c}input:focus-visible,button:focus-visible,a:focus-visible{outline:3px solid #813d6e;outline-offset:3px}.password-field{position:relative}.password-field input{padding-right:126px}.password-toggle{position:absolute;right:7px;top:7px;width:auto;min-height:34px;margin:0;padding:6px 10px;border-color:#813d6e66;background:#fff;color:#6c315c;font:700 13px/1 system-ui,sans-serif}.password-toggle:hover{background:#f8e7ee}.message{color:#813d6e;font-size:15px;margin-bottom:0}.back{display:inline-block;margin-top:28px;color:#615950;font-size:14px;text-underline-offset:4px}.note{font-size:13px;margin:15px 0 0}@media(max-width:380px){main{padding:36px 22px}h1{font-size:32px}.password-field input{padding-right:112px}.password-toggle{font-size:12px}}
...
${message ? `<p class="message" role="alert" id="password-message" data-guest-error>${message}</p>` : ""}
<form method="post" action="/media-access"><label for="password">Wedding password</label>
<div class="password-field"><input id="password" name="password" type="password" autocomplete="current-password" required maxlength="256"${message ? ' aria-describedby="password-message"' : ""}>
<button id="password-visibility" class="password-toggle" type="button" aria-controls="password" aria-pressed="false" data-show-label="Show password" data-hide-label="Hide password">Show password</button></div>
...
<script src="/assets/js/guest-error-popup.js?v=20260921-guest-errors" defer></script>
<script src="/assets/js/media-login.js?v=20260921-guest-errors" defer></script></body></html>`;
